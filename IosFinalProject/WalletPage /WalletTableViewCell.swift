...
class WalletTableViewCell: UITableViewCell {
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconImageView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -32),
            
            currencyLabel.centerYAnchor.constraint(equalTo: iconImageView.centerYAnchor),
            currencyLabel.leadingAnchor.constraint(equalTo: iconImageView.trailingAnchor, constant: 16),
            
            quantityLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 16),
            quantityLabel.bottomAnchor.constraint(equalTo: contentView.centerYAnchor,constant: -8),
            quantityLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            
            balanceLabel.topAnchor.constraint(equalTo: contentView.centerYAnchor,constant: 8),
